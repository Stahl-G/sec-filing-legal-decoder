...
DOMAIN_SUPPORT_PATTERNS: dict[str, tuple[str, ...]] = {
    ...
    "equity_dilution_control": (
        ...
        r"\bearnout\b",
        r"\bpipe\b",
        r"\bsponsor arrangements?\b",
        r"\bregistration rights?\b",
        r"\bredemption history\b",
        r"\block[- ]up\b",
    ...
    "tax_cross_border": (
        ...
        r"\brepatriation\b",
        r"\boffshore holding\b",
        r"\bremittance restrictions?\b",
    ),
    "management_board_governance": (
        ...
        r"\bindependence\b",
        r"\bforeign private issuer\b",
        r"\bfpi\b",
        r"\bhome[- ]country governance\b",
        r"\bhome country practice\b",
    ),
