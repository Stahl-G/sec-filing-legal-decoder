"""Route filing paragraphs before generating v0.2 risk cards."""
...
def route_paragraph(
    ...
    if domains:
        ...
        if not filtered_domains:
            return ParagraphRoute(
                ...
                reason="earnings-release paragraph without a v0.2 legal-risk domain",
                risk_domains=[],
            )
        if (
    ...
    return ParagraphRoute(
        ...
        route_action="route_out",
        reason="no v0.2 legal-risk domain terms detected",
        risk_domains=[],
    )
